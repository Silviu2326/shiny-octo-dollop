...
export default function Level6({ onBack, onNextLevel, onLevelComplete, language = 'en' }) {
    ...
    return (
        <div className="game-container">
            ...
            <div className="ui-overlay">
                ...
                {showVictoryModal && (
                    <div className="level6-super-victory-modal-wrapper">
                        <div className="level6-super-victory-content-box glass-panel">
                            <h2 className="level6-super-victory-title">{gameUI.victory}</h2>
                            <p className="level6-super-victory-subtitle">{gameUI.levelCompleted}</p>

                            <div style={{ margin: '20px 0' }}>
                                <StarRating stars={3} />
                            </div>

                            <div className="level6-super-victory-stats">
                                <div className="level6-super-victory-stat-row">
                                ...
                                <div className="level6-super-victory-stat-total">
                                    {gameUI.totalScore}: {finalScoreStats.total}
                                </div>
                            </div>

                            <div className="level6-super-buttons-row">
                                {onNextLevel && (
                                    <button className="level6-btn-primary" onClick={onNextLevel}>
                                        {gameUI.nextLevel}
                                    </button>
                                )}
                                <button className="level6-btn-secondary" onClick={restartLevel}>
                                    {gameUI.playAgain}
                                </button>
                                <button className="level6-btn-secondary" style={{ backgroundColor: '#333' }} onClick={onBack}>
                                    {gameUI.backToMenu}
                                </button>
                            </div>
                        </div>
                ...
                {showGameOverModal && (
                    <div className="level6-super-loss-modal-wrapper">
                        <div className="level6-super-loss-content-box glass-panel">
                            <h2 className="level6-super-loss-title">
                                {beersCollected / initialCollectibles.length >= 0.7 ? gameUI.goodTry : gameUI.youLost}
                            </h2>
                            <p className="level6-super-loss-subtitle">
                            ...
                            <div className="level6-super-loss-stats">
                                <div className="level6-super-loss-stat-row">
                                    <span>{gameUI.baseScore}:</span>
                                    <span>{finalScoreStats.score}</span>
                                </div>
                                <div className="level6-super-loss-stat-row">
                                ...
                                <div className="level6-super-loss-stat-row" style={{ color: '#FFD700', fontWeight: 'bold', marginTop: '10px' }}>
                                    <span>{gameUI.totalScore}:</span>
                                    <span>{finalScoreStats.total}</span>
                                </div>
                                <div className="level6-super-loss-stat-row" style={{ marginTop: '10px' }}>
                            ...
                            <div className="level6-super-buttons-row">
                                {beersCollected / initialCollectibles.length >= 0.7 && onNextLevel ? (
                                    <button className="level6-loss-btn-primary" style={{ background: 'linear-gradient(135deg, #4CAF50 0%, #2E7D32 100%)' }} onClick={onNextLevel}>
                                        {gameUI.nextLevel}
                                    </button>
                                ) : (
                                    <button className="level6-loss-btn-primary" onClick={restartLevel}>
                                        {gameUI.tryAgain}
                                    </button>
                                )}

                                <button className="level6-btn-secondary" onClick={onBack}>
                                    {gameUI.backToMenu}
                                </button>
                            </div>
                        </div>
                ...
                {showIntroVideo && (
                    <div className="intro-video-overlay" style={{
                        ...
                        <video
                            ref={videoRef}
                            src={language === 'es' ? "/assets/videos/level5_final.mp4" : "/assets/videosingles/LEVEL 5 (1).mp4"}
                            autoPlay
                            playsInline
